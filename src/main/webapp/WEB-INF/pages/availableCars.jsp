<%@ page import="com.rentacar.model.enums.Options" %>
<%@ page import="com.rentacar.model.enums.EconomyClass" %>
<%@ page import="com.rentacar.model.enums.CarTransmission" %>
<%@ page import="com.rentacar.model.enums.CarType" %>
                    ...
                    <table id="centralContentFilterTable">
                                    ...
                                    <c:forEach items="<%=EconomyClass.values()%>" var="ecoClass">
                                        <c:choose>
                                            <c:when test="${filter.economyClass==ecoClass.value}">
                                                <option value="${ecoClass.value}" selected>${ecoClass.value}</option>
                                            </c:when>
                                            <c:otherwise>
                        ...
                        <tr>
                            <td><label for="carTypeFilter">Car Type: </label>
                                <form:select id="carTypeFilter" class="form-control styled-select blue semi-square"
                                             path="carType">
                                    <option value="">Select Value</option>
                                    <c:forEach items="<%=CarType.values()%>" var="carType">
                                        <c:choose>
                                            <c:when test="${filter.carType==carType.value}">
                                                <option value="${carType.value}" selected>${carType.value}</option>
                                            </c:when>
                                            <c:otherwise>
                        ...
                        <tr>
                            <td><label for="optionsFilter">Options: </label>
                                <form:select id="optionsFilter" class="form-control styled-select blue semi-square"
                                             path="options">
                                    <option value="">Select Value</option>
                                    <c:forEach items="<%=Options.values()%>" var="compl">
                                        <c:choose>
                                            <c:when test="${filter.options==compl.value}">
                                                ...
                                                <option value="${compl.value}" selected>${compl.value}</option>
                                            </c:when>
                                            <c:otherwise>
                        ...
                        <tr>
                            <td><label for="transmissionFilter">Transmission: </label>
                                <form:select id="transmissionFilter" class="form-control styled-select blue semi-square"
                                             path="transmission">
                        ...
                        <tr>
                            <td><label for="yearFilter">Year Of Production: </label>
                                <form:select id="yearFilter" class="form-control styled-select blue semi-square"
